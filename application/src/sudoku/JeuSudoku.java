...
public class JeuSudoku extends Application implements Initializable {
	...
	public void drawOnCanvas(GraphicsContext context) {
		...
		// Dessine le contour de la case une fois selectionn�e par le joueur
		...
		// Dessine les s�parations des r�gions du Sudoku
	...
	public void canvasMouseClicked() {
		...
		grille.setOnMouseClicked(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent event) {
				// r�cup�re les coordon�es du clic et les transforme en int
				int mouse_x = (int) event.getX();
				int mouse_y = (int) event.getY();
				//Met � jour la case selectionn�e par le joueur
