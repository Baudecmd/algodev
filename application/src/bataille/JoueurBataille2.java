...
public class JoueurBataille2 extends Joueur {
    ...
    public JoueurBataille2(String nom, ArrayList<Bateau> listeBateaux) {
        super(nom);
        this.listeBateaux = listeBateaux;
    }

    public JoueurBataille2(String nom) {
        super(nom);
    }
    ...
    public boolean tir(int i,int j){    //booléen pour indiquer si un bateau a été touché ou non
        //ATTENTION! Cette fonction n'effectue pas un tir CONTRE le joueur adverse (sinon, celui-ci serait passé en paramètre). C'est au joueur 2 de faire appel à cette fonction du joueur 1 pour effectuer son tir contre celui-ci.
    ...
    public static void main(String[] args) {
        JoueurBataille2 joueur = new JoueurBataille2("germain");
